...
export class sUMAMIApproval extends ethereum.Event {
  get params(): sUMAMIApproval__Params {
    return new sUMAMIApproval__Params(this);
  }
}

export class sUMAMIApproval__Params {
  _event: sUMAMIApproval;

  constructor(event: sUMAMIApproval) {
    this._event = event;
  }
...
export class sUMAMITransfer extends ethereum.Event {
  get params(): sUMAMITransfer__Params {
    return new sUMAMITransfer__Params(this);
  }
}

export class sUMAMITransfer__Params {
  _event: sUMAMITransfer;

  constructor(event: sUMAMITransfer) {
    this._event = event;
  }
...
export class sUMAMI__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sUMAMI extends ethereum.SmartContract {
  static bind(address: Address): sUMAMI {
    return new sUMAMI("sUMAMI", address);
  }
  ...
  rebases(param0: BigInt): sUMAMI__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sUMAMI__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<sUMAMI__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
